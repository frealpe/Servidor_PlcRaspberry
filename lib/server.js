...
class Server {
    ...
    constructor() {
        ...
        this.paths = {
            ...
            marcamedidor:   '/api/marcamedidor',    
            modelomedidor:  '/api/modelomedidor',                        
            medidor:        '/api/medidor',
 ...
 */
    ...
    routes() {
        ...
        this.app.use(this.paths.marcamedidor, require('../routers/marcamedidor'));  
        this.app.use(this.paths.modelomedidor, require('../routers/modelomedidor'));        

...
static const pin_t digitalInputs[] = {
	{"PIN8", PIN8},
...
static const int numDigitalOutputs = sizeof(digitalOutputs) / sizeof(pin_t);
...
static const int numAnalogOutputs = sizeof(analogOutputs) / sizeof(pin_t);
